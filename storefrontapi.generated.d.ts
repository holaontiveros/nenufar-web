...
export type NenufarCollectionCatalogQuery = {
...
export type NenufarAllProductsCatalogQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type NenufarAllProductsCatalogQuery = {
  collections: {
    nodes: Array<
      Pick<StorefrontAPI.Collection, 'title' | 'handle'> & {
        products: {
...
> & {
  ...
  materialLabel?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  technique?: StorefrontAPI.Maybe<{
    reference?: StorefrontAPI.Maybe<{
  ...
  packageIncludes?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  makingProcess?: StorefrontAPI.Maybe<{
    references?: StorefrontAPI.Maybe<{
      nodes: Array<{
  ...
  shippingDetails?: StorefrontAPI.Maybe<{
    references?: StorefrontAPI.Maybe<{
      nodes: Array<{
        body?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
  ...
  packagingDetails?: StorefrontAPI.Maybe<{
    references?: StorefrontAPI.Maybe<{
      nodes: Array<{
        body?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
  ...
  compatibleTechniques?: StorefrontAPI.Maybe<{
    references?: StorefrontAPI.Maybe<{
      nodes: Array<{
        name?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      >;
      seo: Pick<StorefrontAPI.Seo, 'description' | 'title'>;
      materialLabel?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      technique?: StorefrontAPI.Maybe<{
        reference?: StorefrontAPI.Maybe<{
      ...
      weight?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      materials?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      packageIncludes?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      makingProcess?: StorefrontAPI.Maybe<{
        references?: StorefrontAPI.Maybe<{
...
export type ComplementaryProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query NenufarCollectionCatalog(\n    $country: CountryCode\n    $handle: String!\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      handle\n      title\n      description\n      products(first: 100, sortKey: TITLE) {\n        nodes {\n          id\n          title\n          handle\n          description\n          featuredImage {\n            id\n            altText\n            url\n            width\n            height\n          }\n          priceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n            maxVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n          technique: metafield(namespace: "custom", key: "technique") {\n            reference {\n              ... on Metaobject {\n                name: field(key: "name") {\n                  value\n                }\n              }\n            }\n          }\n          leadTime: metafield(namespace: "custom", key: "lead_time") {\n            value\n          }\n        }\n      }\n    }\n  }\n': {
    ...
    variables: NenufarCollectionCatalogQueryVariables;
  };
  ...
  '#graphql\n  query NenufarAllProductsCatalog(\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collections(first: 100) {\n      nodes {\n        title\n        handle\n        products(first: 100, sortKey: TITLE) {\n          nodes {\n            id\n            title\n            handle\n            description\n            featuredImage {\n              id\n              url\n              altText\n              width\n              height\n            }\n            priceRange {\n              minVariantPrice {\n                amount\n                currencyCode\n              }\n              maxVariantPrice {\n                amount\n                currencyCode\n              }\n            }\n            technique: metafield(namespace: "custom", key: "technique") {\n              reference {\n                ... on Metaobject {\n                  name: field(key: "name") {\n                    value\n                  }\n                }\n              }\n            }\n            leadTime: metafield(namespace: "custom", key: "lead_time") {\n              value\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: NenufarAllProductsCatalogQuery;
    variables: NenufarAllProductsCatalogQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
