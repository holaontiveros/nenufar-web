...
const techniques = [
  [
    ...
    'Precisión milimétrica sobre madera, acrílico, cuero y metal.',
    'https://cdn.shopify.com/s/files/1/1010/7702/5053/files/photo-1513519245088-0e12902e5a38.jpg?v=1789051498',
  ],
  [
    'Sublimación Cerámica & Térmica HD',
    'Color vivo, durable y con acabado integrado.',
    'https://cdn.shopify.com/s/files/1/1010/7702/5053/files/photo-1514432324607-a09aefdd.jpg?v=1789051501',
  ],
  [
    'Camisas & Textiles Personalizados',
    'DTF y vinil textil para una pieza o tirajes completos.',
    'https://cdn.shopify.com/s/files/1/1010/7702/5053/files/photo-1597484661643-2f5fef640dd1.jpg?v=1789051504',
  ],
  [
    'Vinil, Adhesivo & Stickers',
    'Troquelado exacto y acabados resistentes al uso diario.',
    'https://cdn.shopify.com/s/files/1/1010/7702/5053/files/photo-1607604276583-eef5d076aa5f.jpg?v=1789051526',
  ],
];
const projects = [
  [
    'Kit de Bienvenida Corporativo Tech & Coffee',
    'Onboarding Empresarial',
    'https://cdn.shopify.com/s/files/1/1010/7702/5053/files/photo-1549465220-1a8b9238cd48.jpg?v=1789051533',
  ],
  [
    'Libro de Firmas y Recuerdos en Madera Grabada',
    'Boda en Jardín & Aniversario',
    'https://cdn.shopify.com/s/files/1/1010/7702/5053/files/photo-1513519245088-0e12902e5a38_6a8b6313-1eb1-45d4-9600-93c78fb7508d.jpg?v=1789051543',
  ],
  [
    'Camisas Familiares y Termos',
    'Bodas de Oro & Celebración Familiar',
    'https://cdn.shopify.com/s/files/1/1010/7702/5053/files/photo-1597484661643-2f5fef640dd1.jpg?v=1789051504',
  ],
];
const reviews = [
  [
    '"La atención fue hermosa y el joyero quedó todavía más especial de lo que imaginaba."',
    'Mariana R. · Regalo personal',
  ],
  [
    '"Cumplieron el tiempo de entrega y cada pieza llegó perfecta para nuestro equipo."',
    'Lucía M. · Empresa / B2B',
  ],
];
...
export function NenufarStory({
  ...
  return (
    <>
      <section id="catalogos" className="story-section">
        <div className="nenufar-shell">
          <StoryHeading
            eyebrow="Colecciones & catálogos Nenúfar"
            title="Regalos que emocionan"
            copy="Cada fecha especial merece una atmósfera y materiales únicos."
          />
    ...
    */}
      <section id="cotizador" className="story-section story-section--tint">
        <div className="nenufar-shell quote-banner">
          <div>
            <span>✦ Taller a medida</span>
            <h2>¿Tienes una idea? La hacemos pieza por pieza.</h2>
            <p>
              Cuéntanos la ocasión, cantidad y materiales que imaginas. Te
              responderemos con opciones, precios y fecha de entrega.
            </p>
          </div>
          {whatsappUrl && (
    ...
    */}
      <section id="faq" className="story-section story-section--tint">
        <div className="nenufar-shell faq-preview">
          <StoryHeading
            eyebrow="Claridad & procesos"
      ...
      <section className="story-final">
        <div>
          ...
          <h2>
            Tu próxima idea merece existir <em>con intención.</em>
          </h2>
          <p>
            Regalos personales, piezas corporativas y detalles que cuentan una
            historia.
          </p>
          {whatsappUrl && (
            <a href={whatsappUrl} target="_blank" rel="noreferrer">
...
export function FaqGroups({ faqGroups }: { faqGroups: FaqGroup[] }) {
  return (
    <>
      {faqGroups.map((group) => (
        <section className="faq__group" key={group.id}>
          <header>
            <h3>{group.title}</h3>
            {group.description && (
              <RichTextContent
                className="faq__group-description"
          ...
          {group.faqs.map(({ question, answer }) => (
            <details key={question}>
              ...
              <RichTextContent className="faq__answer" value={answer} />
            </details>
          ))}
        </section>
      ))}
