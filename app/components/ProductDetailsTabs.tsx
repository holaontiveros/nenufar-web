          ...
          <div className="product-details-grid">
            {(dimensions || weight || technique) && (
              <section>
                ...
                {dimensions && <p><strong>Medidas:</strong> {dimensions}</p>}
      ...
      nextTabs.push({
        ...
        content: (
          <div className="product-details-grid product-details-grid--two-columns">
            {shippingDetails && <section><h3>Tiempos de fabricación y entrega</h3><p className="product-details-preformatted">{shippingDetails}</p></section>}
            {packagingDetails && <section><h3>Cuidado de empaque y protección</h3><p className="product-details-preformatted">{packagingDetails}</p></section>}
          </div>
        ),
      });
    }
